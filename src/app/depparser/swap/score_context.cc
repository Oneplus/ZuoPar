...
ScoreContext::ScoreContext(const State& state):
  ...
  DistS0S1(0), S1Feat(0), S0Feat(0), N0Feat(0),
  N0w(0), N0L2w(0), N0L1w(0), N0R1w(0), N0R2w(0),
  N0p(0), N0L2p(0), N0L1p(0), N0R1p(0), N0R2p(0) {
  ...
  if (S1 >= 0) {
    ...
    if (S1ld >= 0) { S1ldw = FORM[S1ld]; S1ldp = POS[S1ld]; S1ldl = REL[S1ld]; }

    int S1rd = state.right_most_child[S1];
    if (S1rd >= 0) { S1rdw = FORM[S1rd]; S1rdp = POS[S1rd]; S1rdl = REL[S1rd]; }
